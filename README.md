...
- React/Vite review UI for sessions, bookmarks, clips, trash, storage pressure simulation, timeline transport hotkeys, collapsible library browsing, and simple session/clip sorting.
